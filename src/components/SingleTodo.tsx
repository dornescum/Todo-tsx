...
const SingleTodo: React.FC<Props> = ({todo, todos, setTodos}) => {
    ...
    // pt handleEdit am nevoie de 2 argumente eventul & id
    ...
    return (<form className='todos__single' onSubmit={(e) => {
        ...
        {edit ? (// fixme face refresh
            <input value={editTodo} onChange={(e) => {
                setEditTodo(e.target.value)}} className='todos__single--text' ref={inputRef}
            />) : (// ========
